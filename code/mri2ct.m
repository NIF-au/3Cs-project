...
PATH = getenv('PATH');
if isempty(strfind(PATH, 'data/lfs2/software/ubuntu14/minc-itk4-1.9.11-20160202/bin'))
    setenv('PATH', ['/data/lfs2/software/ubuntu14/minc-itk4-1.9.11-20160202/bin:' PATH]);
end

LIB = getenv('LD_LIBRARY_PATH');
if isempty(strfind(LIB, 'data/lfs2/software/ubuntu14/minc-itk4-1.9.11-20160202/lib'))
    setenv('LD_LIBRARY_PATH', ['/data/lfs2/software/ubuntu14/minc-itk4-1.9.11-20160202/lib:' LIB]);
end
...
dos(['mincresample -like MRImnc.mnc -transformation ' fullfile(trpath, trName), ...
...
dos(['mincresample -like MRImnc.mnc -transformation ' fullfile(tr2path, tr2Name), ...
